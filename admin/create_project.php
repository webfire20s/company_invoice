...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-72 bg-slate-950 text-white hidden md:flex flex-col border-r border-slate-800">
        ...
        <nav class="flex-1 px-4 space-y-1 overflow-y">
    ...
    <main class="flex-1 overflow-y-auto">
        <header class="bg-white border-b border-slate-200 px-10 py-6 sticky top-0 z-20 flex justify-between items-center">
            <div>
                ...
                <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">Management / Internal Tracking</p>
            </div>
        </header>
            ...
            <div class="form-card rounded-3xl shadow-xl overflow-hidden p-8">
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="staff_id" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm input-focus outline-none appearance-none">
